  ...
  return (
    <div dir="rtl" className="fixed inset-0 z-[9999] bg-[#050505] flex flex-col font-sans select-none overflow-hidden">
      ...
      <header className="h-14 bg-black/80 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-6 z-[10001]">
          ...
          <h1 className="text-gray-300 font-bold text-[10px] md:text-xs truncate max-w-[150px] md:max-w-md text-center">
            {title}
          </h1>
      ...
      <main className="flex-1 relative bg-[#0a0a0a] flex justify-center items-start overflow-y-auto pt-4 pb-10">
        ...
        {isLoading && (
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-[#0a0a0a] gap-4">
            ...
            <p className="text-[10px] text-gray-600 tracking-widest font-bold">جاري استحضار الرواية...</p>
          </div>
        )}
      ...
      <AnimatePresence>
        {showControls && (
          ...
          >
            ...
            <section className="space-y-6">
              <h4 className="text-[10px] text-gray-500 font-bold uppercase tracking-widest text-right">نمط الصفحات</h4>
