...
// استيراد المكونات اللازمة مع دعم الزووم
...
export default function ModernReader({ pdfUrl, title, onClose }: ModernReaderProps) {
  // حالة التحكم في إظهار قائمة الإعدادات
  ...
  return (
    <div dir="rtl" className="fixed inset-0 z-[9999] bg-[#0a0a0a] flex flex-col font-sans select-none">
      ...
      {/* 1. البار العلوي - مع زر تبديل (Toggle) للإعدادات */}
      <header className="h-14 bg-black border-b border-white/5 flex items-center justify-between px-6 z-[10001]">
          ...
          <h1 className="text-gray-200 font-bold text-xs truncate max-w-md text-center opacity-80">
            {title}
          </h1>
      ...
      {/* 2. منطقة العرض - توسيط الصفحة البيضاء وإصلاح الهيكل */}
      <main className="flex-1 relative overflow-hidden bg-[#111111] flex justify-center p-2 md:p-4">
        <div className="h-full w-full max-w-4xl bg-white shadow-2xl overflow-hidden rounded-sm border border-black/10">
            {/* استخدام الإصدار 3.4.120 لمطابقة مكتبة pdfjs-dist في مشروعك */}
            <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.4.120/build/pdf.worker.min.js">
                <Viewer
                    fileUrl={pdfUrl}
                    // استخدام defaultScale بدلاً من initialScale لتجنب أخطاء TypeScript
          ...
          >
            <section className="space-y-6">
              ...
              <div className="flex items-center justify-between bg-white/5 p-1.5 rounded-2xl border border-white/5">
                ...
                <div className="text-blue-500 font-black text-[11px]">
