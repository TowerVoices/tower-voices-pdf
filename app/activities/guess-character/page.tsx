...
const uiTexts = {
  ar: {
    ...
    rule1Desc: "كلما اخترت مستوى أصعب، زادت فرصتك بشكل كبير للحصول على بطاقات أسطورية ونادرة.",
  ...
  en: {
    ...
    rule1Desc: "Choosing harder levels massively increases your chance for Legendary and Rare cards.",
