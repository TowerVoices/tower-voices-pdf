...
// 1. استعلام Sanity لجلب البيانات الصحيحة للنجوم
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 w-full pb-12">
          <div className="flex flex-col md:flex-row-reverse gap-8 md:gap-12 items-center md:items-end">
            ...
            <div className="relative group shrink-0 flex flex-col items-center">
              ...
              {/* 2. حل مشكلة الـ TypeScript وتغيير fieldName إلى القيمة المقبولة */}
              <div className="mt-4 bg-zinc-900/80 backdrop-blur-md px-4 py-3 rounded-2xl border border-white/10 shadow-2xl w-full flex flex-col items-center gap-2">
                <div className="flex items-center gap-2 text-[10px] font-bold text-blue-400 uppercase tracking-wider">
                  <FaStar className="text-yellow-500" /> تقييم القصة
                </div>
                <InteractiveRating 
                  workId={work._id} 
                  initialRating={work.storyRating || 5} 
                  fieldName="ratingWork"  // تم التغيير من storyRating إلى القيمة الصحيحة
                />
              </div>
            </div>
