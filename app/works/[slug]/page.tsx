...
/**
 * 1. محرك SEO متكامل: تم حذف التكرار لمنع مشكلة الطول الزائد
 */
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const { slug } = await params;
  const work = await getWork(slug);
  
  // تعديل: حذف اسم الموقع من عنوان الخطأ لتجنب التكرار
  ...
  return {
    // تعديل ذهبي: حذفنا "| أصوات البرج" يدوياً لأن ملف الـ Layout سيضيفها تلقائياً
    title: work.title, 
...
// 2. استعلام Sanity الشامل (تم التأكد من جلب القصص الجانبية والتعليقات)
...
export default async function WorkPage({ params }: Props) {
  ...
  return (
    <main dir="rtl" className="bg-[#050505] text-gray-200 min-h-screen font-sans overflow-x-hidden text-right">
      ...
      <section className="relative min-h-[55vh] md:h-[65vh] w-full overflow-hidden flex items-end">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-8 w-full pb-10 md:pb-16">
          <div className="flex flex-col md:flex-row-reverse gap-6 md:gap-10 items-center md:items-stretch w-full">
            ...
            <div className="flex-1 text-center md:text-right w-full flex flex-col">
              <div className="flex flex-col items-center md:items-start md:text-right">
                <div className="flex flex-wrap justify-center md:justify-start gap-2 mb-4 flex-row-reverse">
                ...
                <h1 className="text-3xl md:text-6xl font-black mb-6 text-white tracking-tight leading-tight w-full">{work.title}</h1>
              </div>

              <div className="md:mt-auto flex flex-col sm:flex-row-reverse gap-4 justify-center md:justify-start items-center">
      ...
      <section className="max-w-6xl mx-auto px-5 md:px-8 py-12">
        <div className="grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-8 order-2 lg:order-1">
            ...
            {/* رحلة البرج والقصص الجانبية (المستعادة بالكامل) */}
          ...
          {/* القائمة الجانبية (معلومات العمل + المشاركة) */}
          <div className="lg:col-span-4 space-y-6 order-1 lg:order-2">
            <div className="bg-zinc-900/80 border border-white/10 rounded-[2.5rem] p-8 shadow-2xl flex flex-col">
              ...
              <div className="space-y-6 text-sm flex-1">
                <div className="flex justify-between items-center bg-white/5 p-4 rounded-2xl flex-row-reverse">
      ...
      {/* قسم التعليقات (المستعاد بالكامل) */}
